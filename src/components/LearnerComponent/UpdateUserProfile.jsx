...
const UpdateData = () => {
    const [LearnerId] = useState("1ed64210-1919-4a61-8b98-7ac59ea47941");
    const [editInfo, setEditInfo] = useState({
        profileId: LearnerId
    });
    const [isEditable, setIsEditable] = useState(false);
    const [userId] = useState("1ed64210-1919-4a61-8b98-7ac59ea47941");  //pk
            ...
            <div className="card mx-auto cardcolor" style={{ maxWidth: '500px' }}  >
                <div className="card-body">
                    ...
                    <div className='mb-3' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Avatar alt="User Avatar" src={editInfo.profilePhoto} style={{ width: '100px', height: '100px' }} />
                    </div>

                    <input type="file" id="profile" name="profilePhoto" onChange={handleThumbnailChange} accept="image/jpeg, image/png, image/gif, image/bmp, image/svg+xml" style={{ display: 'none' }} />
                    ...
                    <>
                        {/* <div className="mb-3">
                            <input type="text" name="firstName" className="form-control" placeholder="Learner Profile" value={editInfo.profileId} onChange={handleInputChange} disabled={!isEditable} style={{ display: "none" }} />
                        </div> */}
                        <div className="mb-3">
